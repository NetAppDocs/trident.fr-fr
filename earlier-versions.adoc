...
[role="lead"]
Si vous n'utilisez pas Trident 26.02, la documentation des versions précédentes est disponible sur la base du link:get-help.html["Cycle de vie du support Trident"].
