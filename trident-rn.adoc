...
* Ajout de la prise en charge manuelle de la QoS au pilote ANF, la rendant prête pour la production dans Trident 26.02 ; cette amélioration expérimentale a été introduite dans Trident 25.06.
