...
+
image::../media/aws-eks-01.png[Onglet Modules complémentaires du cluster EKS]

. Accédez à *add-ons* AWS Marketplace et choisissez la catégorie _Storage_.
+
image::../media/aws-eks-02.png[Catégorie de stockage des modules complémentaires AWS Marketplace]
...
+
image::../media/aws-eks-03.png[Sélection de la version du module complémentaire Trident]

. Configurez les paramètres du module complémentaire requis.
+
image::../media/aws-eks-04.png[Paramètres de configuration du module complémentaire Trident]

. Si vous utilisez IRSA (rôles IAM pour le compte de service), reportez-vous aux étapes de configuration supplémentaireslink:https://docs.netapp.com/us-en/trident/trident-use/trident-fsx-install-trident.html#enable-the-trident-add-on-for-aws["ici"] .
. Sélectionnez *Créer*.
. Vérifiez que l'état du complément est _Active_.
+
image::../media/aws-eks-05.png[Trident État actif de l'extension Trident]
...
----
. Poursuivez l'installation et configurez le stockage backend. Pour plus d'informations, consultez link:trident-fsx-storage-backend.html["Configurez le back-end de stockage"].
