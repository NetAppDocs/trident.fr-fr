...
| `maxThroughput` | Définit le débit maximal autorisé. Prise en charge uniquement pour les pools de capacité QoS manuels. *Aperçu technique de Trident 25.06* | `4 MiB/sec` 
|===
