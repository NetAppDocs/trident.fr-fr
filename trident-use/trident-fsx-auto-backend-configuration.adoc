...
Pour une liste complète des paramètres du backend, voir : xref:trident-fsx-storage-backend.html#backend-advanced-configuration-and-examples[Configuration du backend FSx for NetApp ONTAP].
