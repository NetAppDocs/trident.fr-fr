...
Pour obtenir des informations sur les FlexGroups et les charges de travail adaptées aux FlexGroups, reportez-vous à la  https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["Guide des meilleures pratiques et d'implémentation des volumes NetApp FlexGroup"^].
