...
.. Utilisez la commande  `helm upgrade` où  `trident-operator-26.02.0.tgz` correspond à la version vers laquelle vous souhaitez effectuer la mise à niveau.
+
[listing]
----
