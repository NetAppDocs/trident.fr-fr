...
NOTE: Vous pouvez également utiliser d'autres méthodes pour détecter les défaillances de nœud, comme spécifié dans la section <<Intégration de solutions personnalisées de vérification de l'état des nœuds>> ci-dessous.
