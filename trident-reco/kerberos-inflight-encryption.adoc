...
* *On-premise ONTAP* - Trident prend en charge le chiffrement Kerberos sur NFSv3 et les connexions des clusters Red Hat OpenShift et Kubernetes en amont aux volumes ONTAP sur site.
...
* Assurez-vous que tous les volumes utilisés avec le chiffrement Kerberos sont correctement configurés. Reportez-vous à la section Configuration du domaine NetApp (page 13) du  https://www.netapp.com/media/16398-tr-3580.pdf["NetApp Améliorations et guide des bonnes pratiques"^].
...
.Protocoles d'accès
Configurez la règle d'export avec NFS, NFSv3 et les protocoles d'accès.
