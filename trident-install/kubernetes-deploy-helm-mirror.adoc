...
| `tridentK8sTimeout` | Remplace le délai d'expiration par défaut de 180 secondes pour la plupart des opérations d'API Kubernetes (si différent de zéro, en secondes). | `180` 
