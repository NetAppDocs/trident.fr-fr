...
[%collapsible]
====
Pour plus d'informations sur le détachement forcé, veuillez consulterlink:..trident-get-started/kubernetes-customize-deploy.html["Personnalisez l'installation de l'opérateur Trident"] .
