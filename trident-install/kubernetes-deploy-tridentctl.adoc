...
[%collapsible]
====
Pour activer les opérations simultanées du contrôleur Trident afin d'améliorer le débit, ajoutez l' `--enable-concurrency`option lors de l'installation, comme illustré dans cet exemple. Pour plus d'informations sur les pilotes pris en charge, consultez le lien : https://docs.netapp.com/us-en/trident/trident-use/controller-scalability.html#controller-scalability[Controller Scalability documentation].
