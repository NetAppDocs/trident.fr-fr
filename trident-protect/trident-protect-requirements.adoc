...
* Assurez-vous qu’au moins un VolumeSnapshotClass existe. Pour plus d'informations, consultez link:https://docs.netapp.com/us-en/trident/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"].
...
----
====
Pour savoir comment définir des applications et restaurer des machines virtuelles avec Trident Protect, consultez link:trident-protect-kubevirt-vms.html["Protégez les machines virtuelles KubeVirt avec Trident Protect"].
