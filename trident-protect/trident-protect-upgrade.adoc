...
* Si vous effectuez une mise à niveau depuis une version en dehors de la fenêtre de quatre versions, procédez à une mise à niveau en plusieurs étapes. Utilisez les instructions de mise à niveau pour la link:../earlier-versions.html["version antérieure"] version à partir de laquelle vous effectuez la mise à niveau afin de passer à la version la plus récente qui entre dans la fenêtre de quatre versions. Par exemple, si vous utilisez la version 24.10 et souhaitez passer à la version 26.06 :
+
.. Première mise à jour de 24.10 à 25.02.
.. Ensuite, passez de 25.02 à 26.06.
