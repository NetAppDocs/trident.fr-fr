...
| protect.trident.netapp.io/volume-snapshots-ready-to-use-timeout | chaîne | Le délai maximal autorisé pour que les instantanés de volume atteignent l'état prêt à l'emploi. | "30 m" 
