...
NOTE: Pour obtenir le graphique Helm, téléchargez d'abord le graphique Helm sur une machine ayant accès à Internet à l'aide de  `helm pull trident-protect --version 100.2606.0 --repo https://netapp.github.io/trident-protect-helm-chart`, puis copiez le fichier  `trident-protect-100.2606.0.tgz` résultant dans votre environnement hors ligne et installez-le en utilisant  `helm install trident-protect ./trident-protect-100.2606.0.tgz` au lieu de la référence du dépôt à l'étape finale.
