...
NOTE: Les scripts du dépôt Verda sont fournis tels quels et ne sont pas officiellement pris en charge par NetApp. Le support NetApp couvre uniquement le framework des hooks d'exécution au sein de Trident Protect.
