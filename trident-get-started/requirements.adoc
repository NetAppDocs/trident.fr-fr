...
* Versions de cluster FAS, AFF ou ASA r2 (iSCSI, NVMe/TCP et FC) sur site bénéficiant d'un support limité de NetApp. Voirlink:https://mysupport.netapp.com/site/info/version-support["Prise en charge des versions logicielles"] .
