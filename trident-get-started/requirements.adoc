...
* OpenShift 4.12, 4.14 - 4.20 (Si vous prévoyez d'utiliser la préparation de nœud iSCSI avec OpenShift 4.19, la version minimale de Trident prise en charge est la 25.06.1.)
+
...
=== Images de conteneurs requises pour Trident 25.10
