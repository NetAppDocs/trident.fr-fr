...
[role="lead"]
Bien que link:../trident-managing-k8s/tridentctl.html["commandes et options tridentctl"] soit le moyen le plus simple d'interagir avec l'API REST de Trident, vous pouvez utiliser directement le point de terminaison REST si vous préférez.
