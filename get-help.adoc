...
| Version | Fin du support complet | Fin du support limité | Fin de l'auto-assistance 


 a| 
link:https://docs.netapp.com/us-en/trident/index.html["26,06"^]
| Juillet 2027 | Juillet 2028 | Juillet 2029 


 a| 
link:https://docs.netapp.com/us-en/trident/index.html["26,02"^]
| Février 2027 | Février 2028 | Février 2029 
...
Pour obtenir une liste complète des articles de dépannage, consultez  https://kb.netapp.com/Advice_and_Troubleshooting/Cloud_Services/Trident_Kubernetes["Base de connaissances NetApp (identifiant requis)"^].
